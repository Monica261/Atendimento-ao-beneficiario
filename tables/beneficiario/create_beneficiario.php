...
<head>
    ...
    <title>Adicionar Beneficiario</title>
</head>
        ...
        <div clas="span10 offset1">
            <div class="card">
                <div class="card-header">
                    ...
                    <h2 class="text-center"> Adicionar Beneficiario </h2>
                </div>
                <div class="card-body">
                    <form class="form-horizontal" action="contato_beneficiario.php" method="post">
                        <label>Nome:</label>
                        ...
                        <div class="form-actions">
                            ...
                            <a href="../../index_beneficiario.php" type="btn" class="btn btn-lg btn-dark">Voltar</a>
                        </div>
                    </form>
                </div>
            </div>
